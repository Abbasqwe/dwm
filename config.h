...
static const double activeopacity   = .8f;     /* Window opacity when it's focused (0 <= opacity <= 1) */
...
static char normbgcolor[]           = "#180a19";
static char normbordercolor[]       = "#a689a9";
static char normfgcolor[]           = "#eec4f2";
static char selfgcolor[]            = "#eec4f2";
static char selbordercolor[]        = "#eec4f2";
static char selbgcolor[]            = "#B63CBF";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_F8,        setlayout,      {.v = &layouts[0]} },
	{ MODKEY|ShiftMask,             XK_F7,        setlayout,      {.v = &layouts[1]} },
	{ MODKEY|ShiftMask,             XK_F6,        setlayout,      {.v = &layouts[2]} },
	{ MODKEY|ShiftMask,             XK_F4,        setlayout,      {.v = &layouts[3]} },
	{ MODKEY|ShiftMask,             XK_F3,        setlayout,      {.v = &layouts[4]} },
	{ MODKEY|ShiftMask,             XK_F2,        setlayout,      {.v = &layouts[5]} },
	{ MODKEY|ShiftMask,             XK_F1,        setlayout,      {.v = &layouts[6]} },
